...
const Hero = () => {
  return (
    <div className='mt-24 max-w-[1200px] mx-auto relative'>
        ...
        >
          ...
          >
            ...
            <div className='flex gap-6 flex-row text-4xl md:text-6xl text-purple-400 z-20'>
              <motion.a whileHover={{ scale:1.2 }} href='https://github.com/altair3542' target='_blank'>
                  <AiOutlineGithub/>
              </motion.a>

              <motion.a whileHover={{ scale:1.2 }} href='https://www.linkedin.com/in/smserna/' target='_blank'>
                  <AiOutlineLinkedin/>
              </motion.a>

              <motion.a whileHover={{ scale:1.2 }} href='https://www.instagram.com/thiago_mesa/' target='_blank'>
                  <AiOutlineInstagram/>
              </motion.a>
      ...
      >
        <p className='text-gray-200 mr-6'>My thech stack</p>
